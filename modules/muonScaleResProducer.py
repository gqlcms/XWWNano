...
muonScaleRes2016a = lambda: muonScaleResProducer('roccor.Run2UL.v5','RoccoR2016aUL.txt', 2016)
muonScaleRes2016b = lambda: muonScaleResProducer('roccor.Run2UL.v5','RoccoR2016bUL.txt', 2016)
muonScaleRes2017 = lambda: muonScaleResProducer('roccor.Run2UL.v5','RoccoR2017UL.txt', 2017)
muonScaleRes2018 = lambda: muonScaleResProducer('roccor.Run2UL.v5','RoccoR2018UL.txt', 2018)
