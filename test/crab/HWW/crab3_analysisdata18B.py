...
config.General.requestName   = 'data18B'
...
config.JobType.scriptExe = 'rundata18B.sh'
config.JobType.allowUndistributedCMSSW = True

config.section_("Data")
config.Data.inputDataset = '/JetHT/Run2018B-UL2018_MiniAODv2_NanoAODv9-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'data18B'
