...
config.General.requestName   = 'data18D'
...
config.JobType.scriptExe = 'rundata18D.sh'
config.JobType.allowUndistributedCMSSW = True

config.section_("Data")
config.Data.inputDataset = '/JetHT/Run2018D-UL2018_MiniAODv1_NanoAODv2-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'data18D'
