...
class fatJetUncertaintiesProducer(Module):
    def __init__(
        ...
        print "jetsmear input parameter"
        print "globalTag,",globalTag
        print "jetType,",jetType,
        print "self.jerInputFileName,",self.jerInputFileName,
        print "self.jerUncertaintyInputFileName,",self.jerUncertaintyInputFileName,
        print "self.jmrVals,",self.jmrVals,
