...
class btagSFProducer(Module):
    ...
    def __init__(
        ...
        supported_btagSF = {
            ...
            'deepjet': {
                'UL2016Pre': {
                    'inputFileName': "Format_wp_deepJet_106XUL16preVFP_v2.csv",
                    'measurement_types': {
                        0: "comb",  # b
                        1: "comb",  # c
                        2: "incl"   # light
                ...
                'UL2016Post': {
                    'inputFileName': "Format_wp_deepJet_106XUL16postVFP_v3.csv",
                    'measurement_types': {
                        0: "comb",  # b
                        1: "comb",  # c
                        2: "incl"   # light
                ...
                'UL2017': {
                    'inputFileName': "Format_wp_deepJet_106XUL17_v3.csv",
                    'measurement_types': {
                        0: "comb",  # b
                        1: "comb",  # c
                        2: "incl"   # light
                ...
                'UL2018': {
                    'inputFileName': "Format_wp_deepJet_106XUL18_v2.csv",
                    'measurement_types': {
                        0: "comb",  # b
                        1: "comb",  # c
                        2: "incl"   # light
