...
def OptimalCut(B,S,NORM_s1):
    ...
    for RightEnd in range(Bins,0,-1):
        for LeftEnd in range(1,RightEnd+1):            #print LeftEnd,RightEnd;
           ...
           # print("Integral is",S.Integral(LeftEnd , RightEnd) );
           # print("sig = ",sig)
            if sig>SigMax: 
...
class ANALYSIS:
    ...
    def DefineSelection_0lep(self):#==========[ 0lep REGIONS & SELECTION ]===========================================
        ...
        PS2="("+PS1+")&& Nj8==2 && nbtag_deep>=0 && HT>1400 ";
        PS3="("+PS1+")&& Nj8==3";
        PS=" jetAK8puppi_V1_probHww4qvsQCD_a >=0 && jetAK8puppi_V1_probHww4qvsQCD_a <=1 && jetAK8puppi_V1_probHww4q3qvsQCD_a >=0 && jetAK8puppi_V1_probHww4q3qvsQCD_a <= 1 && V1_evqqvsQCD_a >=0 && V1_evqqvsQCD_a <=1 &&  V1_mvqqvsQCD_a>=0 && V1_mvqqvsQCD_a<=1 && V1_emvqqvsQCD_a>=0 && V1_emvqqvsQCD_a <=1 && V1_hadtauvqqvsQCD_a >=0 && V1_hadtauvqqvsQCD_a<=1 && V1_leptaumvqqvsQCD_a>=0 && V1_leptaumvqqvsQCD_a<=1 && V1_leptauevqqvsQCD_a>=0 && V1_leptauevqqvsQCD_a<=1 && Nj8==2 && Mj_a>30";
        PS4 = " 1 ";
        PS5=" deepWH_Nj2_a == 1 ";
        MET1New="("+PS+")  && MET_et/PTj_a<0.3";
        TaggerCut1 ="("+PS+")  && MET_et/PTj_a<0.3 && jetAK8puppi_V1_probHww4q3qvsQCD_a >0.95" 
        TaggerCut2 ="("+PS+")  && MET_et/PTj_a>0.3 && V1_emvqqvsQCD_a>0.5" 
        MET2="Nj8==2 && MET_et/PTj_a>=0.3 && MET_et/PTj_a < 0.6";
        MET2New="("+PS+")  && MET_et/PTj_a>0.3";
    ...
    def Make_Controlplots_for_0lep(self,selection,selection2,tag,CR=0):
        ...
        if MODE in ["MC","MCvsDATA","DECO"]:
            ...
            self.construct_plot(Nj, "Mj_a"    ,selection          ,"",tag  ,50, 0 ,250,"Mj_a, Nj=2"                        ,"Events" ,logy,CR);             
            ...
            self.construct_plot(Nj, "MET_et"    ,selection          ,"",tag  ,20, 0 ,200,"MET, Nj=2"                        ,"Events" ,logy,CR);             
            ...
            self.construct_plot(Nj, "MET_et/PTj_a"    ,selection          ,"",tag  ,20, 0 ,0.5,"MET/PT_H, Nj=2"                        ,"Events" ,logy,CR);             
            self.construct_plot(Nj, "MET_et/((PTj_a + PTj_b + PTj_c)**0.5)"    ,selection          ,"",tag  ,20, 0 ,7,"MET Significance, Nj=2"                        ,"Events" ,logy,CR);             
            ...
            # self.construct_plot(Nj,"jetAK8puppi_V1_probHww4qvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"Hww4qvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(jetAK8puppi_V1_probHww4qvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"Hww4qvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
          
            # self.construct_plot(Nj,"jetAK8puppi_V1_probHww4q3qvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"Hww4q3qvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(jetAK8puppi_V1_probHww4q3qvsQCD_a,0.2)", selection                    ,"",tag  ,2,  0 , 1    ,"Hww4q3qvsQCD_a , Nj=2"           ,"Events" ,logy,CR); 
            # self.construct_plot(Nj,"V1_evqqvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"HwwevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_evqqvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"HwwevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"V1_mvqqvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"HwwmvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_mvqqvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"HwwmvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"V1_emvqqvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"HwwemvqqvsQCD_a(new combined) , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_emvqqvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"HwwemvqqvsQCD_a(new combined) , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"V1_hadtauvqqvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"HwwhadtauvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_hadtauvqqvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"HwwhadtauvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"V1_leptaumvqqvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"HwwleptaumvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_leptaumvqqvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"HwwleptaumvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"V1_leptauevqqvsQCD_a", selection                    ,"",tag  ,20,  0 , 1    ,"HwwleptauevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_leptauevqqvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1    ,"HwwleptauevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
    ...
    def construct_plot(self,Nj,variable,cut,cut1,tag,nbin,min,max,xtitle="",ytitle="",logy=1,CR=0):
        ...
        if MODE=="MC":
            h_Signal1.Scale(5*NORM_s1);
            h_Signal2.Scale(NORM_s1);
        ...
        if MODE in ["MC","MCvsDATA"]:
            ...
            theLeg.AddEntry(h_Signal1,"qqlnu #times %s "%(5*NORM_s1),"L");
            theLeg.AddEntry(h_Signal2,"qqqq #times %s "%(NORM_s1),"L");
