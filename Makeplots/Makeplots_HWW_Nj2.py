...
class ANALYSIS:
    ...
    def Make_Controlplots_for_0lep(self,selection,selection2,tag,CR=0):
        ...
        if MODE in ["MC","MCvsDATA","DECO"]:
            ...
            self.construct_plot(Nj,"jetAK8puppi_V1_probHww4qvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"Hww4qvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(jetAK8puppi_V1_probHww4qvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"Hww4qvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
          
            self.construct_plot(Nj,"jetAK8puppi_V1_probHww4q3qvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"Hww4q3qvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(jetAK8puppi_V1_probHww4q3qvsQCD_a,0.2)", selection                    ,"",tag  ,2,  -0.05 , 1.05    ,"Hww4q3qvsQCD_a , Nj=2"           ,"Events" ,logy,CR); 
            self.construct_plot(Nj,"V1_evqqvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(V1_evqqvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"V1_mvqqvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwmvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(V1_mvqqvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwmvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"V1_emvqqvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwemvqqvsQCD_a(new combined) , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(V1_emvqqvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwemvqqvsQCD_a(new combined) , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"V1_hadtauvqqvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwhadtauvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(V1_hadtauvqqvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwhadtauvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"V1_leptaumvqqvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwleptaumvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(V1_leptaumvqqvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwleptaumvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"V1_leptauevqqvsQCD_a", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwleptauevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            self.construct_plot(Nj,"pow(V1_leptauevqqvsQCD_a,0.2)", selection                    ,"",tag  ,22,  -0.05 , 1.05    ,"HwwleptauevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
    ...
    def construct_plot(self,Nj,variable,cut,cut1,tag,nbin,min,max,xtitle="",ytitle="",logy=1,CR=0):
        ...
        if MODE in ["MC","MCvsDATA"]:
            ...
            theLeg.AddEntry(h_Signal1,"qqlnu #times %s "%(NORM_s1),"L");
