...
cp $BASEPATH/run_1LeptonSF.py $CMSSW_BASE/src/PhysicsTools/NanoAODTools/python/postprocessing/analysis/test
cp $BASEPATH/keep_and_drop1lepton.txt $CMSSW_BASE/src/PhysicsTools/NanoAODTools/python/postprocessing/analysis/test
cp $BASEPATH/VVVProducer_1LeptonSF.py $CMSSW_BASE/src/PhysicsTools/NanoAODTools/python/postprocessing/analysis/modules
echo "analysis/test dir"
pwd
ls -lth

echo python run_1LeptonSF.py -i $LOCALInputFile $ADDTIONALArgs
python run_1LeptonSF.py -i $LOCALInputFile $ADDTIONALArgs
