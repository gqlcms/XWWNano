...
parser.add_option('--Input'    , action="store",type="string",dest="Input"          ,default=None)
...
parser.add_option('--MODE'    , action="store",type="string",dest="MODE"          ,default=None)
parser.add_option('--Nperjobs'    , action="store",type="int",dest="Nperjobs"          ,default=None)
...
if options.MODE == "XWWNano":
    ...
    for i in Input_:
        ...
        if not os.path.isfile(i):
            sys.exit(i+" does not exists")
        Input.append(os.path.normpath(i))
